...
def build_optimizer_and_scheduler(model, configs):
    ...
    optimizer = torch.optim.AdamW(model.parameters(), lr=configs.train.lr)

    # SWG
    # optimizer = torch.optim.SGD(model.parameters(), lr=configs.train.lr)
    # optimizer = torchcontrib.optim.SWA(optimizer, swa_start=4, swa_freq=1, swa_lr=0.05)
